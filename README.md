...
`URLEncoder` en java `urllib.parse.quote` en python
...
#### CODE_400
Se manda a la switch cuando el rango de bytes es incorrecto (E.j. si los bytes de inicio son mayores que los bytes finales)
```
